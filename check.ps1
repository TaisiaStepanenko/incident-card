...
Add-SourceFeatureAssessment -Ctx $ctx -Id 'excellent.polished_report' -Level 'excellent' -Category 'report' -Requirement 'Polished report with tables and summary' -Patterns @('Timeline','Summary','\|.*\|') -Match 'all'
